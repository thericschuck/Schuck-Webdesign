 ...
 * existieren nicht in /api/admin/jarvis/cockpit, nur als Layout-/Render-Diskriminator. */
 ...
 * lib/jarvis/agent.ts. Wird hier als eigenständiger, statischer Zweig direkt am
