 ...
 * Browser-Tabs (HELM-Chat) oder künftig durch Cron-getriggerte Agenten-Läufe, die
 * niemand aktiv im Blick hat. Ein reiner Seitenaufruf-Fetch würde solche Läufe erst nach
 * einem manuellen Reload zeigen — für "live zuschauen, während HELM arbeitet" reicht
