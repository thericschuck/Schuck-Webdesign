 ...
 * 'claude-opus-4-8'`) — die erlaubte Liste wird deshalb im Code-Katalog geführt
 * (lib/helm/catalog/models.ts) und von hier nur re-exportiert, statt hier eine zweite,
 * separat gepflegte Kopie zu halten. */
export { ALLOWED_AGENT_MODELS } from '@/lib/helm/catalog/models'

/** Vom Node-Panel bearbeitbare Agenten-Felder — Antwortform von GET/PATCH
 * /api/admin/helm/agents/[id] UND PUT .../tools (jeweils der volle, aktuelle Stand nach
 ...
 * dessen Eltern-Agenten aufruft). `executor` bekommt bewusst einen neutralen Grauton — ein
 * bislang unbenutztes Scaffolding-Relikt, kein "echter" Sub-Agent wie die anderen 6.
 */
