...
// console.error. Der eigentliche Chat-Flow (runJarvisAgent) darf davon nie
// unterbrochen werden — siehe lib/jarvis/agent.ts.
...
async function resolveAgentId(slug: string): Promise<string | null> {
  try {
    ...
    console.error(`[jarvis/observability] agents-Lookup für Slug "${slug}" fehlgeschlagen:`, error)
    return null
  }
}
...
export async function startAgentRun(input: StartRunInput): Promise<string | null> {
  try {
    ...
    console.error('[jarvis/observability] agent_runs-Insert fehlgeschlagen:', error)
    return null
  }
}
...
export async function resumeAgentRun(runId: string): Promise<void> {
  try {
    ...
    console.error('[jarvis/observability] agent_runs-Resume fehlgeschlagen:', error)
  }
}
...
export async function markAgentRunWaitingHuman(runId: string): Promise<void> {
  try {
    ...
    console.error('[jarvis/observability] agent_runs-Update (waiting_human) fehlgeschlagen:', error)
  }
}
...
export async function finalizeAgentRun(input: FinalizeRunInput): Promise<void> {
  try {
    ...
    console.error('[jarvis/observability] agent_runs-Finalize fehlgeschlagen:', error)
  }
}
...
export async function startToolCallStep(input: StartStepInput): Promise<string | null> {
  try {
    ...
    console.error('[jarvis/observability] agent_steps-Insert fehlgeschlagen:', error)
    return null
  }
}
...
export async function retryToolCallStep(input: RetryStepInput): Promise<void> {
  try {
    ...
    console.error('[jarvis/observability] agent_steps-Retry-Update fehlgeschlagen:', error)
  }
}
...
export async function finishToolCallStep(input: FinishStepInput): Promise<void> {
  try {
    ...
    console.error('[jarvis/observability] agent_steps-Update fehlgeschlagen:', error)
  }
}
